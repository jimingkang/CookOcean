...
public class UserController extends BaseController {
	 ...
	 */
	@Get("/registerPerson")
	public String registerPerson(Invocation inv,TAirshuttleUser user){
	...
	public String modifyPersonMsg(TAirshuttleUser user){
	 ...
	 */
	@Get("/getPersonMsg")
	public String getPersonMsg(Invocation inv){
