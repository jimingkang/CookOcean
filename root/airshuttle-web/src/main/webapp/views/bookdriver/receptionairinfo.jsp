...
function search()
{
	var form=document.getElementById('findreception');
//	var status=document.getElementById('receptionCity');
//status.value=val;
...
<div>
	<div class="wsite-multicol">
		...
		<center>
	<form action="${pageContext.request.contextPath}/bookdriver/findReceptionAir" method="GET" id="findreception">	
	留学学校：<input type="text" name="receptionSchool" id="receptionSchool" />
		...
		<input type="hidden" name="pageNumber" value="1"/>
			...
			<table class="wsite-multicol-table" border=1>
				...
				<tr class="wsite-multicol-tr">
							...
							<td>
							<font style="font-weight: normal;" size="4">驾照</font></h2>
							</td>
							<td>
...
<form action="${pageContext.request.contextPath}/bookdriver/insertuserbookdriver" method="GET" id="${item.id}">	
					<tr class="wsite-multicol-tr">
							...
							<td >
							<font style="font-weight: normal;" size="4"><img src="${item.drivingLicenseUrl}" width="120" height="150"></img></font>
							</td>
							<td>
							...
							<td>
							<font style="font-weight: normal;" size="4"><input type=text name="bookPrice" id="bookPrice-${item.id}" size="4" value="${item.price}"/></font>
				
					
							</td>
							<td>
							<font style="font-weight: normal;" size="4"><input type=text name="pickUpTime" id="pickUpTime-${item.id}" width='25%' value="${item.openTime}"/></font>
				
					
							</td>	
							<td>
						
							<a class='wsite-button' onclick="check(${item.id},'0')"><span class='wsite-button-inner'>预约</span></a>
				            ...
				            <input type="hidden" name="receptionAirId" value="${item.id}"/> 
					</tr>
