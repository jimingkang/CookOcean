...
//-->
	...
	<script type="text/javascript" src="http://cdn2.editmysite.com/js/lang/zh/ftl.js?buildTime=1234"></script>
			...
			<div id="nav">
				<ul class="wsite-menu-default">
					<li id="active" class="wsite-menu-item-wrap">
						<a href="${pageContext.request.contextPath}/views/index.jsp" class="wsite-menu-item">接机</a>

					</li>
					<li id="pg398593238625168252" class="wsite-menu-item-wrap">
						<a href="${pageContext.request.contextPath}/views/houserent.jsp" data-membership-required="0" class="wsite-menu-item">租房</a>

					</li>
					<li class="wsite-menu-item-wrap">
						<a href="${pageContext.request.contextPath}/views/contact.jsp" class="wsite-menu-item">联系我们</a>

					</li>

					<li id="pg217308836783333756" class="wsite-menu-item-wrap">
						<a href="${pageContext.request.contextPath}/views/about.jsp" data-membership-required="0" class="wsite-menu-item">关于</a>
				...
				<div>
					<form  action="${pageContext.request.contextPath}/flygroup/findFlyGroup" method="GET" id="form-345595193178583968">
							...
							<ul class="formlist" id="345595193178583968-form-list">
								<div>
									<div class="wsite-form-field" style="margin:5px 0px 5px 0px;">
										<label class="wsite-form-label" for="input-795658422777773873">
											to University
						...
						<div style="text-align:left; margin-top:10px; margin-bottom:10px;">
							...
							<a class='wsite-button' onclick="document.getElementById('form-345595193178583968').submit()">
				...
				<div id='443138725433304280-gallery' class='imageGallery' style='line-height: 0px; padding: 0; margin: 0'>
						...
						<div id='443138725433304280-insideImageContainer0' style='position:relative;margin:5px;'>
							<div class='galleryImageHolder' style='position:relative; width:100%; padding:0 0 75%;overflow:hidden;'>
								<div class='galleryInnerImageHolder'>
									<a href='${pageContext.request.contextPath}/flygroup/findFlyGroup?admissionSchool=南加大&pageSize=3&pageNumber=1' title='南加大'>
										<img src='../uploads/4/6/6/6/46660685/8250516.jpg' class='galleryImage' _width='400' _height='300' style='position:absolute;border:0;width:100%;top:0%;left:0%' />
									</a>
								</div>
							</div>
						</div>
					</div>
					<div id='443138725433304280-imageContainer1' style='float:left;width:33.28%;margin:0;'>
						<div id='443138725433304280-insideImageContainer1' style='position:relative;margin:5px;'>
							<div class='galleryImageHolder' style='position:relative; width:100%; padding:0 0 75%;overflow:hidden;'>
								<div class='galleryInnerImageHolder'>
									<a href='${pageContext.request.contextPath}/flygroup/findFlyGroup?admissionSchool=南加大&pageSize=3&pageNumber=1'  title='南加大'>
										<img src='../uploads/4/6/6/6/46660685/4271401.jpg' class='galleryImage' _width='400' _height='300' style='position:absolute;border:0;width:100%;top:0%;left:0%' />
									</a>
								</div>
							</div>
						</div>
					...
					<div id='443138725433304280-imageContainer2' style='float:left;width:33.28%;margin:0;'>
						<div id='443138725433304280-insideImageContainer2' style='position:relative;margin:5px;'>
							<div class='galleryImageHolder' style='position:relative; width:100%; padding:0 0 75%;overflow:hidden;'>
								<div class='galleryInnerImageHolder'>
									<a href='${pageContext.request.contextPath}/flygroup/findFlyGroup?admissionSchool=UCB&pageSize=3&pageNumber=1' title='UCB'>
										<img src='../uploads/4/6/6/6/46660685/8173544.jpg' class='galleryImage' _width='400' _height='300' style='position:absolute;border:0;width:100%;top:0%;left:0%' />
									</a>
								</div>
							</div>
						</div>
					...
					<div id='443138725433304280-imageContainer3' style='float:left;width:33.28%;margin:0;'>
						<div id='443138725433304280-insideImageContainer3' style='position:relative;margin:5px;'>
							<div class='galleryImageHolder' style='position:relative; width:100%; padding:0 0 75%;overflow:hidden;'>
								<div class='galleryInnerImageHolder'>
									<a href='${pageContext.request.contextPath}/flygroup/findFlyGroup?admissionSchool=UCLA&pageSize=3&pageNumber=1'>
										<img src='../uploads/4/6/6/6/46660685/9414246.jpg' class='galleryImage' _width='400' _height='300' style='position:absolute;border:0;width:100%;top:0%;left:0%' />
									</a>
								</div>
							</div>
						</div>
...
<div id="footer-wrap">
	<div class="container">
		Create a
		<a target="_top" href="http://www.weebly.com/">free web site</a>
		with
		<a target="_top" href="http://www.weebly.com/" title="free web site">Weebly</a>
	</div>
	<!-- end container -->
</div>
<!-- end footer-wrap -->
