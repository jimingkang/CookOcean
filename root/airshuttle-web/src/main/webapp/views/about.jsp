...
<html>
	<head>
		<title>About - fly the Ocean</title>
...
//-->
	...
	<body class="short-header-page  wsite-theme-light  wsite-page-about"><div id="header-wrap">
        <div class="container">
