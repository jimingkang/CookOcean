			...
			<table class="wsite-multicol-table">
				...
				<c:forEach var="item" items="${rows}" varStatus="status"> 
					...
					<tr class="wsite-multicol-tr">
						<td class="wsite-multicol-col" style="width:14.040404040404%; padding:0 20px;">

							<div>
							<div class="wsite-image wsite-image-border-none " style="padding-top:10px;padding-bottom:10px;margin-left:0;margin-right:0;text-align:center">
							<a>
							<img src="../../uploads/4/6/6/6/46660685/page-layouts-7162985.jpg" alt="Picture" style="width:auto;max-width:100%" />
							</a>
							...
							<td class="wsite-multicol-col" style="width:85.959595959596%; padding:0 20px;">


							<h2 class="wsite-content-title" style="text-align:left;">
							<font size="5" color="red">团名:${item.groupName}</font><br />
							<font style="font-weight: normal;" size="4">报名截止时间：${item.expirationDate}</font><br />
							<font style="font-weight: normal;" size="4">出发地：${item.departAirport}</font><br />
							<font style="font-weight: normal;" size="4">出发时间：${item.departTime}</font><br />
							<font style="font-weight: normal;" size="4">航班号：${item.flight}</font><br />
							<font style="font-weight: normal;" size="4">预计到达时间：${item.arriveTime}</font>
