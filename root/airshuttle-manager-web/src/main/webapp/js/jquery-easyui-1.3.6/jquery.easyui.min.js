...
(function ($) {
	function _a0(_a1) {
		...
		$cursorTxt = $("<input type=\"hidden\" value=\"0\" name=\"cursor\">").appendTo(tr).wrap("<td></td>");
		$cursorTxt.change(function () {
			var _cursorTxt = parseInt($(this).val()) || 0;
			_cursorChange(_a1, _cursorTxt);
			return false;
		});
	...
	function _cursorChange(_ae, _af) {
		var _b0 = $.data(_ae, "pagination").options;
		_b1(_ae, { cursor: _af });
		_b0.onSelectPage.call(_ae, _b0.pageNumber, _b0.pageSize, _b0.cursor);
	}

	function _ad(_ae, _af) {
		var _b0 = $.data(_ae, "pagination").options;
		_b1(_ae, { pageNumber: _af });
		_b0.onSelectPage.call(_ae, _b0.pageNumber, _b0.pageSize, _b0.cursor || 0);
	};
	...
	function _b1(_b2, _b3) {
		...
		var cur = $(_b2).find("input[name='cursor']");
		if (cur.length) {
			cur.val(_b5.cursor + "");
			_b5.cursor = parseInt(cur.val());
		}
	...
	$.fn.pagination.defaults = {
		total: 1, pageSize: 10, pageNumber: 1, pageList: [10, 20, 30, 50], loading: false, buttons: null, showPageList: true, showRefresh: true, links: 10, layout: ["list", "sep", "first", "prev", "sep", "manual", "sep", "next", "last", "sep", "refresh"],
		onSelectPage: function (_c6, _c7, _cursor) {
...
(function ($) {
	...
	function _5a6(_5a7) {
		...
		if (opts.pagination) {
			...
			_5ae.pagination({
				...
				onSelectPage: function (_5af, _5b0, _cursor) {
					opts.pageNumber = _5af;
					opts.pageSize = _5b0;
					_5ae.pagination("refresh", { pageNumber: _5af, pageSize: _5b0, cursor: _cursor || 0 });
					_5d9(_5a7);
				}
			});
	...
	function _5da(_611, data) {
		...
		if (_616.length) {
			...
			if (_617.total != data.total) {
				_616.pagination("refresh", { total: data.total, cursor: data.cursor || 0 });
	...
	function _68d(_68e, _68f) {
		...
		$(_68e).datagrid("getPager").pagination("refresh", { total: data.total, cursor: data.cursor || 0 });
	};
	function _693(_694, _695) {
		...
		_696.push(_695.row);
		$(_694).datagrid("getPager").pagination("refresh", { total: data.total, cursor: data.cursor || 0 });
	};
	function _697(_698, row) {
		...
		_699.push(row);
		$(_698).datagrid("getPager").pagination("refresh", { total: data.total, cursor: data.cursor || 0 });
	};
	function _69a(_69b) {
	...
	function _5d9(_6ae, _6af) {
		...
		if (opts.pagination) {
			var tmp = opts.cursor;
			opts.cursor = $("input[name='cursor']").val();
			opts.cursor = opts.cursor == "undefined" ? (tmp == "undefined" ? 0 : tmp) : opts.cursor;
			$.extend(_6b0, { page: opts.pageNumber || 1, rows: opts.pageSize, cursor: opts.cursor });
		}
	...
	$.fn.datagrid.methods = {
		options: function (jq) {
			...
			return jq.each(function () {
				...
				_6e9.pagination("refresh", { pageNumber: 1, cursor: 0 });
				_5d9(this, _6e8);
			});
	...
	$.fn.datagrid.parseOptions = function (_710) {
		var t = $(_710);
		return $.extend({}, $.fn.panel.parseOptions(_710), $.parser.parseOptions(_710,
            ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle",
                ...
                { pagination: "boolean", pageSize: "number", pageNumber: "number", cursor: "number" },
	...
	$.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
		...
		striped: false,
		method: "post",
		nowrap: true, idField: null, url: null, data: null,
		loadMsg: "Processing, please wait ...", rownumbers: false,
		singleSelect: false, ctrlSelect: false, selectOnCheck: true,
		checkOnSelect: true, pagination: false,
		pagePosition: "bottom",
		pageNumber: 1,
		pageSize: 10,
		cursor: 0,
		...
		rowStyler: function (_74e, _74f) {
			...
			$.ajax({
				type: opts.method, url: opts.url, data: _750, dataType: "json", success: function (data) {
					_751(data);
				}, error: function () {
			...
			getTr: function (_753, _754, type, _755) {
				type = type || "body";
				_755 = _755 || 0;
...
(function ($) {
	...
	function _781(_782) {
		...
		$(_782).datagrid($.extend({}, opts, {
			cls: "propertygrid", view: (opts.showGroup ? opts.groupView : opts.view), onClickCell: function (_784, _785, _786) {
				if (_780 != this) {
					_787(_780);
					_780 = this;
				}
	...
	var _791 = $.extend({}, $.fn.datagrid.defaults.view, {
		render: function (_792, _793, _794) {
			var _795 = [];
	...
	$.fn.propertygrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
		singleSelect: true, remoteSort: false, fitColumns: true, loadMsg: "", frozenColumns: [[{ field: "f", width: 16, resizable: false }]], columns: [[{ field: "name", title: "Name", width: 100, sortable: true }, { field: "value", title: "Value", width: 100, resizable: false }]], showGroup: false, groupView: _791, groupField: "group", groupFormatter: function (_7b8, rows) {
			return _7b8;
		}
	});
})(jQuery);
(function ($) {
	function _7b9(_7ba) {
		...
		if (opts.pagination) {
			...
			_7cf.pagination({
				...
				onSelectPage: function (_7d0, _7d1, _cursor) {
					opts.pageNumber = _7d0;
					opts.pageSize = _7d1;
					opts.cursor = _cursor || 0;
					_7d2(_7ba);
				}
			});
	...
	function _831(_832, _833) {
		...
		_7db(_832);
		_834.total -= 1;
		$(_832).datagrid("getPager").pagination("refresh", { total: _834.total, cursor: data.cursor || 0 });
	...
	var _84b = $.extend({}, $.fn.datagrid.defaults.view, {
		render: function (_84c, _84d, _84e) {
	...
	$.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
		treeField: null, lines: false, animate: false, singleSelect: true, view: _84b, loader: function (_888, _889, _88a) {
			var opts = $(this).treegrid("options");
			if (!opts.url) {
				return false;
			}
			$.ajax({
				type: opts.method, url: opts.url, data: _888, dataType: "json", success: function (data) {
					_889(data);
				}, error: function () {
			...
			getTr: function (_88c, id, type, _88d) {
				type = type || "body";
				_88d = _88d || 0;
...
(function ($) {
	function _894(_895) {
		...
		$(_895).addClass("combo-f").textbox($.extend({}, opts, {
			icons: _898, onChange: function () {
			}
		}));
	...
	$.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
		inputEvents: { click: _8a4, keydown: _8a8, paste: _8a8, drop: _8a8 }, panelWidth: null, panelHeight: 200, panelMinWidth: null, panelMaxWidth: null, panelMinHeight: null, panelMaxHeight: null, panelAlign: "left", multiple: false, selectOnNavigation: true, separator: ",", hasDownArrow: true, delay: 200, keyHandler: {
			up: function (e) {
			}, down: function (e) {
			}, left: function (e) {
			}, right: function (e) {
...
(function ($) {
	...
	$.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
		valueField: "value", textField: "text", groupField: null, groupFormatter: function (_91b) {
			return _91b;
...
(function ($) {
	function _941(_942) {
		...
		var grid = _943.grid;
		$(_942).addClass("combogrid-f").combo($.extend({}, opts, {
			onShowPanel: function () {
...
(function ($) {
	function _96b(_96c) {
		...
		$(_96c).addClass("datebox-f").combo($.extend({}, opts, {
			onShowPanel: function () {
				_96e();
		...
		function _96f() {
			...
			$.extend(_96d.calendar.calendar("options"), {
...
(function ($) {
	function _98b(_98c) {
		...
		$(_98c).datebox("calendar").calendar({
			onSelect: function (date) {
...
(function ($) {
	...
	function _9c0(_9c1) {
		...
		_9c3.find("a.slider-handle").draggable({
	...
	$.fn.slider.defaults = {
		width: "auto", height: "auto", mode: "h", reversed: false, showTip: false, disabled: false, value: 0, min: 0, max: 100, step: 1, rule: [], tipFormatter: function (_9e2) {
			return _9e2;
		}, converter: {
			toPosition: function (_9e3, size) {
				var opts = $(this).slider("options");
